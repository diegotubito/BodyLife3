...
class NetwordManager {
    ...
    func delete(url: String, body: [String : Any]?, response: @escaping (Data?, ServerError?) -> Void) {
    ...
    func update(url: String, body: [String : Any]?, response: @escaping (Data?, ServerError?) -> Void) {
        //create the url with NSURL
        let urlTransformmed = URL(string: url)!
